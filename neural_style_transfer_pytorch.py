...
#Gradient Descent
#As Leon Gatys, the author of the algorithm, suggested here <https://discuss.pytorch.org/t/pytorch-tutorial-for-neural-transfert-of-artistic-style/336/20?u=alexis-jacq>__, we will use L-BFGS algorithm to run our gradient descent.
...
def run_style_transfer(cnn, normalization_mean, normalization_std,
                       content_img, style_img, input_img, num_steps=600, # num_steps=300,
    ...
    while run[0] <= num_steps:
        ...
        def closure():
            ...
            if run[0] % 50 == 0:
                ...
                #plt.figure()
                #imshow(input_img, title='とちゅうイメージ')
...
style_name = 'gogh_ziga_hat_768_1024' #'picasso' # myself, gypsy, gogh_1
content_name = 'nagi_768_1024' #'nettest' # norikae, seishin, makiba

# desired size of the output image
#imsize = 512 if torch.cuda.is_available() else 128  # use small size if no gpu
#imsize=(512,512)
#注：高さ・幅 height - width の模様
imsize=(1024, 768)
...
utils.save_image(output, "./" + style_name + "+" + content_name + ".jpg")
